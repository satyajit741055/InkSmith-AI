...
async def list_blogs(current_user:current_user,
    ...
    result = await db.execute(select(BlogGeneration).where(BlogGeneration.user_id==current_user.id, BlogGeneration.status=="completed").order_by(BlogGeneration.updated_at.desc()))
